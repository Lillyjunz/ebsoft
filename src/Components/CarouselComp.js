    ...
    <Slider {...settings} className="container mt-5">
      ...
      <div>
        ...
        >
          ...
          <p>
            They took the time to understand our unique challenges and delivered
            exceptional solutions. Moving from a single software engineer
            managing our website to a cost-effective, company-wide collaboration
            with EBSOFT has been a game-changer.
          </p>
          <div className="pt-3">
      ...
      <div>
        ...
        >
          ...
          <p>
            ...
            web app projects. Their hands-on expertise in cloud architecture and
            automation helped us scale faster than anticipated, especially in
            API and backend development with Airline GDS, ensured a smooth
      ...
      <div className="slide-div">
        ...
        >
          ...
          <p>
            ...
            in operational costs and a 30% increase in productivity. We can now
